      ...
      <Content>
        ...
        <ThreeColRow>
          <LogoContainer>
            ...
            <LogoText>ZoukSchool</LogoText>
          </LogoContainer>
          <CopywrightNotice>
            &copy; {new Date().getFullYear()} ZoukSchool. All Rights Reserved.
          </CopywrightNotice>
          <SocialLinksContainer>
            <SocialLink href="https://www.facebook.com/tiagomovimentuss/">
              <FacebookIcon />
            </SocialLink>
            {/**<SocialLink href="https://www.instagram.com/tiagomovimentus/">
              <InstagramIcon />
  </SocialLink>***/}
            <SocialLink href="https://www.youtube.com/@TiagoMovimentus">
              <YoutubeIcon />
            </SocialLink>
          </SocialLinksContainer>
        </ThreeColRow>
